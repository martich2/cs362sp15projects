...
int adventurerCard(int drawntreasure, int currentPlayer, int cardDrawn,
...
int feastCard(int i, int currentPlayer, int temphand[MAX_HAND], int x,
...
int mineCard(int j, int currentPlayer, int choice1, int choice2, int handPos,
		int i, struct gameState* state) {
...
int remodelCard(int j, int currentPlayer, int choice1, int choice2,
		int handPos, int i, struct gameState* state) {
	j = state->hand[currentPlayer][choice1]; //store card we will trash
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	case adventurer:
		...
		adventurerCard(drawntreasure, currentPlayer, cardDrawn, temphand, z,
				state);
		break;
	...
	case feast:
		...
		feastCard(i, currentPlayer, temphand, x, choice1, state);
		break;
	...
	case mine:
		...
		mineCard(j, currentPlayer, choice1, choice2, handPos, i, state);
		break;

	case remodel:

		remodelCard(j, currentPlayer, choice1, choice2, handPos, i, state);
		return 0;
